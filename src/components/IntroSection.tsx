...
export default function IntroSection() {
    ...
    return (
        <motion.section
            className={`${isScreenWidthLessThan900 ? "px-8 flex-col justify-center gap-y-10 text-center" : "px-24 justify-around gap-x-16 flex-row"} text-left flex items-center py-12`}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5, ease: "easeOut" }}
        >
            <div className="space-y-2 sm:space-y-5">
                <h1 className="text-5xl xs:text-6xl">
                    I&apos;m
                ...
                <p className={`${isScreenWidthLessThan900 ? "text-md xs:text-xl" : "text-2xl"} font-bold dark:font-normal dark:text-slate-100`}>I&apos;m a aspiring frontend developer with expertise in JavaScript, TypeScript, React and Redux. My passion lies in crafting seamless web experiences, with a knack for integrating backend services and APIs. Let&apos;s explore how my skills can transform your digital vision into reality.</p>
